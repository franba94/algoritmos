...
sumaAcumulada2 :: [Int] -> [Int]
sumaAcumulada2 [] = []
sumaAcumulada2 (x:xs) = sumatoria (x:xs) : sumaAcumulada2 (principio (x:xs))

sumaAcumulada :: [Int] -> [Int]
sumaAcumulada (x:xs) = reverso (sumaAcumulada2 (x:xs))
